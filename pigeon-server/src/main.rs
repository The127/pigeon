...
async fn run_api(
    ...
    let state = AppState {
        create_application: Arc::new(CreateApplicationHandler::new()),
        update_application: Arc::new(UpdateApplicationHandler::new()),
        delete_application: Arc::new(DeleteApplicationHandler::new()),
        ...
        create_event_type: Arc::new(CreateEventTypeHandler::new(event_type_read_store.clone())),
        update_event_type: Arc::new(UpdateEventTypeHandler::new()),
        delete_event_type: Arc::new(DeleteEventTypeHandler::new()),
        ...
        create_endpoint: Arc::new(CreateEndpointHandler::new(event_type_read_store.clone())),
        update_endpoint: Arc::new(UpdateEndpointHandler::new(event_type_read_store.clone())),
        delete_endpoint: Arc::new(DeleteEndpointHandler::new()),
        ...
        create_organization: Arc::new(CreateOrganizationHandler::new(organization_read_store.clone())),
        update_organization: Arc::new(UpdateOrganizationHandler::new()),
        delete_organization: Arc::new(DeleteOrganizationHandler::new()),
        ...
        create_oidc_config: Arc::new(CreateOidcConfigHandler::new()),
        delete_oidc_config: Arc::new(DeleteOidcConfigHandler::new()),
        ...
        replay_dead_letter: Arc::new(ReplayDeadLetterHandler::new()),
        retry_attempt: Arc::new(RetryAttemptHandler::new()),
        retrigger_message: Arc::new(RetriggerMessageHandler::new(message_read_store.clone(), endpoint_read_store, attempt_read_store.clone())),
